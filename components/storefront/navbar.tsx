...
import {Modal, ModalHeader, ModalBody, ModalFooter, ModalTitle, HStack} from 'rsuite'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/website" className="flex items-center gap-3 group">
                        <div
                            className="w-9 h-9 bg-gradient-to-br from-primary to-accent rounded-xl flex items-center justify-center group-hover:shadow-lg group-hover:shadow-primary/50 transition-all">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link href="/website/cart" className="relative p-2 hover:bg-secondary rounded-lg transition">
                            ...
                            {totalItems > 0 && (
                                <span
                                    className="absolute top-0 right-0 bg-primary text-primary-foreground text-xs rounded-full w-5 h-5 flex items-center justify-center">
                                  {totalItems}
                                </span>
                            )}
                        </Link>
                        ...
                        {user ? (
                            <div className="relative group">
                                ...
                                <div
                                    className="absolute right-0 mt-1 w-52 bg-card border border-border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                    ...
                                    <Link href="/dashboard" className="block px-4 py-2 hover:bg-secondary text-sm">
                                        <HStack spacing={10}>
                                          <MdDashboard />
                                          Dashboard
                                        </HStack>
                                    ...
                                    <Modal open={logoutModalOpen} backdrop={"static"}
                                           onClose={() => setLogoutModalOpen(false)} draggable>
                                        <ModalHeader>
                                        ...
                                        <ModalFooter>
                                            <Button appearance="subtle"
                                                    onClick={() => setLogoutModalOpen(false)}>Cancel</Button>
                                            <Button
                                                appearance="primary"
                                                color="red"
