...
**Source:** `@/components/ui/RSuite/DataPickers/CheckPicker`

## Props

| Prop | Type | Required | Inherited From | Description |
|------|------|----------|----------------|-------------|
| `countable` | `boolean` |  | `CheckPickerProps` |  |
| `renderValue` | `(value: T[],  item: Option\<T\>[],  selectedElement: React.ReactNode) =\> React.ReactNode` |  | `CheckPickerProps` |  |
| `sticky` | `boolean` |  | `CheckPickerProps` |  |
...
---
*Auto-generated from rsuite type definitions. Refer to [rsuite documentation](https://rsuitejs.com/components/checkpicker/#props) for full details.*
