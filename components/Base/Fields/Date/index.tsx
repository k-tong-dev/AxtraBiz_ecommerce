...
const PICKER_STYLES = {
  toggle: { borderTop: 0, borderRight: 0, borderLeft: 0, borderRadius: 0, outlineColor: 'transparent', boxShadow: 'none' },
  input: { border: 'none', outline: 'none', backgroundColor: 'transparent' },
}
