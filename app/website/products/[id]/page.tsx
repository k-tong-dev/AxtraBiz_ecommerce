...
export default function ProductDetailPage() {
  ...
  return (
    <div className="py-12 bg-background min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Back Button */}
        <Link href="/website/products" className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-primary/80 mb-8 group transition-colors duration-300">
