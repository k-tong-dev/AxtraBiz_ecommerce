    ...
    return (
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-50/70 via-white to-cyan-50/50 dark:from-emerald-950/30 dark:via-slate-950 dark:to-cyan-950/30">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-emerald-300/30 to-cyan-300/20 blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
          <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-teal-300/25 to-sky-200/20 blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
        </div>
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-violet-50/70 via-white to-rose-50/50 dark:from-violet-950/40 dark:via-slate-950 dark:to-rose-950/30">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-violet-300/30 to-rose-300/20 blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
