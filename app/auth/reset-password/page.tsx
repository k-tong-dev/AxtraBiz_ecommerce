...
import {
  Lock, Loader2, CheckCircle2, AlertCircle, ArrowLeft, Eye, EyeOff, KeyRound, ShieldCheck, RefreshCw, Sparkles, Settings, Star, Shield, Mail, Sword,
} from 'lucide-react'
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-rose-50 via-white to-red-50/40 dark:from-rose-950/40 dark:via-slate-900 dark:to-red-950/40 p-4">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="relative">
            <div className="absolute -bottom-3 left-6 right-6 h-3 rounded-3xl bg-gradient-to-b from-rose-500/20 to-transparent blur-xl" />
            <div className="absolute -bottom-1.5 left-12 right-12 h-1.5 rounded-3xl bg-gradient-to-b from-rose-500/30 to-red-500/20" />
            <div className="relative rounded-3xl border border-border/40 bg-card/90 shadow-2xl shadow-black/10 backdrop-blur-2xl overflow-hidden p-8 text-center space-y-5">
              <div className="h-1 bg-gradient-to-r from-rose-500 via-red-500 to-pink-500 -m-8 mb-0" />
              ...
              <h1 className="text-xl font-bold">Quest failed</h1>
              <p className="text-sm text-muted-foreground">This reset link is no longer valid. Request a new one.</p>
              <Link href="/auth/forgot-password">
                <Button className="w-full h-12 relative overflow-hidden group" appearance="primary">
                  <span className="relative z-10 flex items-center justify-center font-bold tracking-wide">
                    <RefreshCw className="w-4 h-4 mr-2" />
                    Start new quest
                  </span>
                  <div className="absolute inset-0 bg-gradient-to-r from-rose-600 via-red-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity" />
                </Button>
              </Link>
            </div>
          </div>
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="relative">
            ...
            <div className="relative rounded-3xl border border-border/40 bg-card/90 shadow-2xl shadow-black/10 backdrop-blur-2xl overflow-hidden p-8 text-center space-y-5">
              ...
              <h1 className="text-xl font-bold">Quest complete!</h1>
              <p className="text-sm text-muted-foreground">Password updated. Returning to sign in...</p>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 lg:px-8 py-8 grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
        <div className="hidden lg:flex flex-col gap-6 max-w-md">
          <div className="flex items-center gap-2.5">
            <div className="relative">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 flex items-center justify-center shadow-lg shadow-emerald-500/25">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Create a strong password to keep your realm safe.
            </p>
          </div>
            ...
            <div className="relative rounded-3xl border border-border/40 bg-card/90 shadow-2xl shadow-black/10 backdrop-blur-2xl overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 pt-5 pb-3 border-b border-border/30">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-amber-600 tracking-wider">SECURE</span>
                </div>
              ...
              <div className="px-6 pt-4">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10px] font-semibold text-muted-foreground/70 tracking-wider uppercase">Step 3 of 3</span>
                  <span className="text-[10px] font-bold text-primary">100%</span>
                </div>
                <div className="h-1.5 rounded-full bg-muted/50 overflow-hidden">
                  <div className="h-full w-full rounded-full bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 relative overflow-hidden">
              ...
              <div className="px-6 py-6 space-y-5">
                <div>
                  <h2 className="text-2xl font-bold tracking-tight">Forge new key</h2>
                  <p className="text-sm text-muted-foreground mt-1">Create a strong password to secure your account</p>
                </div>
                  ...
                  <Form ref={formRef} model={model} onSubmit={onSubmit} fluid formDefaultValue={{ password: '', confirmPassword: '' }}>
                    <div className="space-y-3.5">
                      <div className="relative">
                        ...
                        <div className="relative">
                          <FormField name="password" type={showPassword ? 'text' : 'password'} placeholder="Min. 6 characters" />
                      ...
                      <div className="relative">
                        ...
                        <FormField name="confirmPassword" type="password" placeholder="Confirm new key" />
                      </div>
                    </div>
                    ...
                    <Button type="submit" className="w-full h-12 mt-5 relative overflow-hidden group" appearance="primary" loading={submitting}>
                      <span className="relative z-10 flex items-center justify-center font-bold tracking-wide">
                        ...
                        {submitting ? 'Forging...' : 'Forge new key'}
                      </span>
              ...
              <div className="px-6 py-4 border-t border-border/30 bg-muted/20 flex items-center justify-between">
                <Link href="/auth/signin" className="text-xs text-muted-foreground/70 hover:text-primary transition-colors inline-flex items-center gap-1 font-bold">
