      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="relative">
            ...
            <div className="relative rounded-2xl border border-white/40 dark:border-white/10 bg-white/80 dark:bg-slate-900/70 p-8 shadow-2xl shadow-blue-500/10 backdrop-blur-2xl">
              ...
              <div className="space-y-4">
                <Button
                  className="w-full h-11 bg-white hover:bg-slate-50 dark:bg-slate-800 dark:hover:bg-slate-700 border border-border/60 transition-all duration-200"
                  appearance="default"
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white/80 dark:bg-slate-900/70 px-3 text-muted-foreground/80 backdrop-blur">or sign in with email</span>
                  </div>
                </div>
              ...
              <p className="mt-6 text-center text-sm text-muted-foreground/80">
                ...
                <Link href="/business-register" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">
                  Create one
                </Link>
              </p>
            </div>
