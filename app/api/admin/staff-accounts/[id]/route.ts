...
import { fetchStaffAccountFromDrizzle, staffAccountService, deleteStaffAccountFromDrizzle } from '@/lib/drizzle/staff-accounts'
...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const result = await staffAccountService.write(id, body)
    if (result.success) {
