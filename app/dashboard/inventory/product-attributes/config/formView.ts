...
export const productAttributeFormConfig: FormConfig = {
      ...
      fields: [
        {
          ...
          groupColumn: 1,
          order: 1,
          fetchUrl: '/api/dashboard/product-attribute-values',
        }
      ],
      order: 100
    }
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/inventory/product-attributes',
    create: '/dashboard/inventory/product-attributes/new',
    edit: '/dashboard/inventory/product-attributes'
  }
}
