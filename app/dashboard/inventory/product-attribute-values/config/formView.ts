...
export const productAttributeValueFormConfig: FormConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      groupColumn: 2,
      order: 3,
      fetchUrl: '/api/dashboard/product-attributes',
    },
    {
      key: 'position',
      label: 'Position',
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/inventory/product-attribute-values',
    create: '/dashboard/inventory/product-attribute-values/new',
    edit: '/dashboard/inventory/product-attribute-values'
  }
}
