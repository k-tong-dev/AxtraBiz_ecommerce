...
export const productFormConfig: FormConfig = {
  ...
  pages: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Category',
          type: 'many2one',
          fetchUrl: '/api/dashboard/categories',
          required: false,
          placeholder: 'Select category',
          columnWidth: 1,
          groupNumber: 1,
      ...
      fields: [
        {
          ...
          widgetConfig: {
            ...
            junctionTable: '/api/dashboard/product-attributes-rel',
            localField: 'product_id',
            remoteField: 'attribute_id',
            // Related records
            relation: '/api/dashboard/product-attributes',
            displayField: 'name',
            valueField: 'id',
      ...
      fields: [
        {
          ...
          order: 1,
          widgetConfig: {
            relation: '/api/dashboard/product-variants',
  ...
  breadcrumbs: {
    ...
    create: '/dashboard/inventory/products/new',
    edit: '/dashboard/inventory/products'
  }
}
