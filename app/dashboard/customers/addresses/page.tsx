...
export default function AdminAddressesPage() {
  ...
  const { data: addresses, loading, refresh } = useResource<Address[]>('/api/dashboard/addresses')
  ...
  const openEdit = (row: Address) => router.push(`/dashboard/customers/addresses/${row.id}/edit`)
