...
export const paymentTransactionFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/dashboard/payment-transactions',
  fields: [
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/sales/payment-transactions',
    create: '/dashboard/sales/payment-transactions/new',
    edit: '/dashboard/sales/payment-transactions'
  }
}
