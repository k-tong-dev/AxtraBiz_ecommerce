...
export const pageFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'status', label: 'Status', type: 'selection', required: true, options: [{ value: 'draft', label: 'Draft' }, { value: 'published', label: 'Published' }, { value: 'archived', label: 'Archived' }], columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 0 },
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/content/pages',
    create: '/dashboard/content/pages/new',
    edit: '/dashboard/content/pages'
  }
}
