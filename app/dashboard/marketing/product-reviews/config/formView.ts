...
export const productReviewFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/dashboard/product-reviews',
  fields: [
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/marketing/product-reviews',
    create: '/dashboard/marketing/product-reviews/new',
    edit: '/dashboard/marketing/product-reviews'
  }
}
