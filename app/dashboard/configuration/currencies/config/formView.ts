...
export const currencyFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/dashboard/currencies',
  fields: [
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/configuration/currencies',
    create: '/dashboard/configuration/currencies/new',
    edit: '/dashboard/configuration/currencies'
  }
}
