...
export const paymentMethodFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/dashboard/payment-methods',
  fields: [
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/configuration/payment-methods',
    create: '/dashboard/configuration/payment-methods/new',
    edit: '/dashboard/configuration/payment-methods'
  }
}
