...
export const auditLogFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/dashboard/audit-logs',
  fields: [
    { key: 'user_id', label: 'User', type: 'string', placeholder: 'User ID', columnWidth: 1, groupNumber: 1, groupColumn: 1, order: 0 },
    { key: 'action', label: 'Action', type: 'selection', required: true, options: [{ value: 'create', label: 'Create' }, { value: 'update', label: 'Update' }, { value: 'delete', label: 'Delete' }, { value: 'login', label: 'Login' }, { value: 'logout', label: 'Logout' }, { value: 'export', label: 'Export' }, { value: 'import', label: 'Import' }, { value: 'restore', label: 'Restore' }], columnWidth: 1, groupNumber: 1, groupColumn: 2, order: 1 },
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/configuration/audit-logs',
    create: '/dashboard/configuration/audit-logs/new',
    edit: '/dashboard/configuration/audit-logs',
  },
}
