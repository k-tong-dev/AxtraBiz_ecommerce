...
export const shippingMethodFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/dashboard/shipping-methods',
  fields: [
  ...
  breadcrumbs: {
    base: '/dashboard',
    list: '/dashboard/configuration/shipping-methods',
    create: '/dashboard/configuration/shipping-methods/new',
    edit: '/dashboard/configuration/shipping-methods'
  }
}
