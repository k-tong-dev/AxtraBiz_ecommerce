...
export const addressFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'type', label: 'Type', type: 'string', placeholder: 'billing, shipping', columnWidth: 1, groupNumber: 1, groupColumn: 2, order: 1 },
  ...
  breadcrumbs: {
    ...
    create: '/admin/addresses/new',
    edit: '/admin/addresses'
  }
}
