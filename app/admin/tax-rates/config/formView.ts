...
export const taxRateFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'rate', label: 'Rate (%)', type: 'string', required: true, placeholder: '20.00', columnWidth: 1, groupNumber: 1, groupColumn: 2, order: 1 },
  ...
  breadcrumbs: {
    ...
    create: '/admin/tax-rates/new',
    edit: '/admin/tax-rates'
  }
}
