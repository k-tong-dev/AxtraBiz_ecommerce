...
export const announcementFormConfig: FormConfig = {
  ...
  apiEndpoint: '/api/admin/marketing/announcements',
  fields: [
    {
      key: 'id',
      label: 'ID',
  ...
  breadcrumbs: {
    base: '/admin',
    list: '/admin/marketing/announcements',
    create: '/admin/marketing/announcements/new',
    edit: '/admin/marketing/announcements'
  }
}
