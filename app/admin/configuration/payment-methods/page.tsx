...
export default function AdminPaymentMethodsPage() {
  ...
  const openCreate = () => router.push('/admin/configuration/payment-methods/new')
  const openEdit = (row: PaymentMethod) => router.push(`/admin/configuration/payment-methods/${row.id}/edit`)
