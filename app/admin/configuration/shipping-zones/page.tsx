...
export default function AdminShippingZonesPage() {
  ...
  const openCreate = () => router.push('/admin/configuration/shipping-zones/new')
  const openEdit = (row: ShippingZone) => router.push(`/admin/configuration/shipping-zones/${row.id}/edit`)
