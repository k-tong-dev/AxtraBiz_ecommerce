...
export default function AdminConfigurationsPage() {
  ...
  const openCreate = () => router.push('/admin/configuration/configurations/new')

  const openEdit = (c: Configuration) => router.push(`/admin/configuration/configurations/${c.id}/edit`)
