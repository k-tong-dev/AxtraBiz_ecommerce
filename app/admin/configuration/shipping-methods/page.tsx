...
export default function AdminShippingMethodsPage() {
  ...
  const openCreate = () => router.push('/admin/configuration/shipping-methods/new')
  const openEdit = (row: ShippingMethod) => router.push(`/admin/configuration/shipping-methods/${row.id}/edit`)
