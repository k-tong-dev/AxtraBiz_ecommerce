  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex gap-3 pt-2">
        <Link href="/admin/shipping-zones/new" className="inline-flex items-center gap-2 rounded-lg bg-primary/10 text-primary px-4 py-2 text-sm font-medium hover:bg-primary/20 transition-colors">
          <Globe className="w-4 h-4" />
          Add Shipping Zone
        </Link>
        <Link href="/admin/shipping-zones" className="inline-flex items-center gap-2 rounded-lg bg-muted px-4 py-2 text-sm font-medium hover:bg-muted/80 transition-colors">
          View All Zones
        </Link>
        <Link href="/admin/shipping-methods" className="inline-flex items-center gap-2 rounded-lg bg-muted px-4 py-2 text-sm font-medium hover:bg-muted/80 transition-colors">
          View All Methods
        </Link>
      </div>
    </div>
