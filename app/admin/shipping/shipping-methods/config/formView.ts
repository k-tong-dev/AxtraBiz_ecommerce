...
export const shippingMethodFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'rate_type', label: 'Rate Type', type: 'selection', required: true, options: [{ value: 'flat', label: 'Flat Rate' }, { value: 'per_item', label: 'Per Item' }, { value: 'weight_based', label: 'Weight Based' }, { value: 'free', label: 'Free Shipping' }], columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 0 },
  ...
  breadcrumbs: {
    base: '/admin',
    list: '/admin/shipping/shipping-methods',
    create: '/admin/shipping/shipping-methods/new',
    edit: '/admin/shipping/shipping-methods'
  }
}
