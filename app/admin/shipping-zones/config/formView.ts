...
export const shippingZoneFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'base_rate', label: 'Base Rate', type: 'string', placeholder: '5.99', columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 0 },
    { key: 'free_shipping_threshold', label: 'Free Shipping Threshold', type: 'string', placeholder: '50.00', columnWidth: 1, groupNumber: 2, groupColumn: 2, order: 1 },
    { key: 'active', label: 'Active', type: 'boolean', columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 2 },
  ],
  breadcrumbs: {
    base: '/admin',
    list: '/admin/shipping-zones',
    create: '/admin/shipping-zones/new',
    edit: '/admin/shipping-zones'
  }
}
