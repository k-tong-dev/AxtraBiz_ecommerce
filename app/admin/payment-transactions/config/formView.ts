...
export const paymentTransactionFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'status', label: 'Status', type: 'string', placeholder: 'pending / completed / failed / refunded', columnWidth: 1, groupNumber: 1, groupColumn: 2, order: 1 },
    { key: 'amount', label: 'Amount', type: 'string', required: true, placeholder: '0.00', columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 0 },
    { key: 'currency', label: 'Currency', type: 'string', placeholder: 'USD', columnWidth: 1, groupNumber: 2, groupColumn: 2, order: 1 },
    { key: 'payment_method', label: 'Payment Method', type: 'string', required: true, placeholder: 'stripe / paypal', columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 2 },
  ...
  breadcrumbs: {
    ...
    create: '/admin/payment-transactions/new',
    edit: '/admin/payment-transactions'
  }
}
