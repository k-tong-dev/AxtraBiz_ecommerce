...
export const paymentTransactionFormConfig: FormConfig = {
  ...
  fields: [
    ...
    { key: 'payment_method', label: 'Payment Method', type: 'selection', options: [{ value: 'stripe', label: 'Stripe' }, { value: 'paypal', label: 'PayPal' }], columnWidth: 1, groupNumber: 2, groupColumn: 1, order: 2 },
